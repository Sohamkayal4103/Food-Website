    ...
    <div>
      ...
      {showModal ?
        (
          ...
          <div className="md:w-2/3 mx-4 mt-24 md:mx-64 w-4/5 bg-white p-2 w-screen ml-10 rounded-lg">
            ...
            <div className="py-6 m-2">
              ...
              <div class="flex justify-end mt-4">
                <a href ="/" className="shadow-lg p-2 rounded-md text-md m-2" rel="noopener noreferrer" target="_blank">Watch video</a>
                <button onClick={handleClick} className="shadow-lg p-2 rounded-md text-md m-2">Close</button>
              </div>
            </div>
          </div>
          </div>
